...
class _HomeViewState extends State<HomeView> {
  ...
  late final RandomArticleViewModel _randomArticleViewModel;
  late final TimelineViewModel _timelineViewModel;
  late final SavedArticlesViewModel _savedArticlesViewModel;
  ...
  void didChangeDependencies() {
    ...
    if (!_isInitialized) {
      _randomArticleViewModel = RandomArticleViewModel(
      ...
      _savedArticlesViewModel = SavedArticlesViewModel(
  ...
  @override
  void dispose() {
    _randomArticleViewModel.dispose();
    _timelineViewModel.dispose();
    _savedArticlesViewModel.dispose();
    super.dispose();
  }
    ...
    return Scaffold(
      ...
      body: Row(
        children: [
          ...
          Expanded(
            child: [
              RandomArticlePageView(viewModel: _randomArticleViewModel),
              TimelinePageView(viewModel: _timelineViewModel),
              SavedArticlesView(viewModel: _savedArticlesViewModel),
            ][_selectedIndex],
          ),
        ],
      ),
